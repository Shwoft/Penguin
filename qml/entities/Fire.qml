...
Monster {
    ...
    property alias sprite: fireSprite
    ...
    property alias dieFire: dieSprite

    // set image
    TexturePackerAnimatedSprite {
        id: fireSprite
        source: "../../assets/livefire/sprite/left.json"
        frameNames: ["left-0.png", "left-1.png", "left-2.png", "left-3.png"]
        interpolate: false
    ...
    Image {
        ...
        TexturePackerAnimatedSprite {
            id: dieSprite
            source: "../../assets/livefire/sprite/extinguish-left.json"
            frameNames: ["extinguish-left-0.png", "extinguish-left-1.png", "extinguish-left-2.png", "extinguish-left-3.png", "extinguish-left-4.png", "extinguish-left-5.png"]
            interpolate: false
    ...
    BoxCollider {
        ...
        anchors.top: fireSprite.bottom
        anchors.left: fireSprite.left
    ...
    BoxCollider {
        ...
        height: 5
        anchors.top: fireSprite.bottom
        anchors.right: fireSprite.right
