...
Monster {
    id: fatbat
    variationType: "fatbat"

    property alias sprite: fatbatSprite
    ...
    property alias dieFatbat: burnSprite
    ...
    TexturePackerAnimatedSprite {
        id: fatbatSprite
        source: "../../assets/fatbat/sprite/fly.json"
        frameNames: ["fly-0.png", "fly-1.png", "fly-2.png", "fly-3.png"]
        interpolate: false
    ...
    Image {
        ...
        TexturePackerAnimatedSprite {
            id: burnSprite
            source: "../../assets/fatbat/sprite/burn.json"
            frameNames: ["burn-0.png", "burn-1.png", "burn-2.png", "burn-3.png", "burn-4.png", "burn-5.png", "burn-6.png", "burn-7.png", "burn-8.png", "burn-9.png", "burn-10.png"]
            interpolate: false
    ...
    function die() {
        ...
        fatbatSprite.visible = false
        audioManager.playSound("fatbatDie")
    }
